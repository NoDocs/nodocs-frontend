...
export const transMoveNode = (leftOp, rightOp, side) => {
  ...
  switch (rightOp.type) {
    ...
    case 'move_node': {
      ...
      // for the rest we have l.length === 1
        ...
        l[1] = {
          type: 'insert_node',
          path: (r[1]).path.concat(
            li.path.slice((r[0]).path.length)
          ),
          node: { text: '' },
        }
      }
